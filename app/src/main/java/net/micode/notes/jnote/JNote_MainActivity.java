 ...
 */
package net.micode.notes.jnote;

import java.util.Calendar;

import net.micode.notes.jnote.db.NoteDB;
import net.micode.notes.jnote.db.NoteDB.Note;
...
public class JNote_MainActivity extends BaseActivity implements OnItemClickListener {
    ...
    protected void initViews(Bundle savedInstanceState) {
        setContentView(R.layout.jnote_activity_main);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.jnote_menu_main, menu);
        return true;
    }
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        ...
        inflater.inflate(R.menu.jnote_data_menu, menu);
    }
