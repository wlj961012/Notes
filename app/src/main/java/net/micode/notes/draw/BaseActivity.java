...
public abstract class BaseActivity extends AppCompatActivity {
  protected Toolbar toolbar;//=findViewById(R.id.toolbar_layout_root);
  protected TextView titleTv;//=findViewById(R.id.toolbar_layout_title_tv);
  ...
  @Override public void setContentView(@LayoutRes int layoutResID) {
    ...
    toolbar=findViewById(R.id.toolbar_layout_root);
    titleTv=findViewById(R.id.toolbar_layout_title_tv);
